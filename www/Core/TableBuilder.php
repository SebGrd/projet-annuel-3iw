...
class TableBuilder
{
    ...
    private static function generateHeader($titles): string
    {
        ...
        $html .= '<th style="width:80px">Edit</th>';
        $html .= '</tr></thead>';
        return $html;
    }
    ...
    private static function generateRows($data, $titles, $modelName): string
    {
        ...
        foreach ($data as $row) {
            ...
            $html .= '<td style="width:80px">
                <a href="/admin/'. $modelName .'?id=' . $row->id . '" class="btn btn-dark btn-icon-small">
                ...
                <a href="/?id=' . $row->id . '" class="btn btn-primary btn-icon-small">
                ...
                <a href="/?id=' . $row->id . '" class="btn btn-danger btn-icon-small">
