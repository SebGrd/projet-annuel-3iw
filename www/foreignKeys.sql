...
ALTER TABLE `DBNAMEorder` ADD CONSTRAINT `order_address` FOREIGN KEY (`address_id`) REFERENCES `DBNAMEaddress` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION;
...
ALTER TABLE `DBNAMEmenu_product` ADD CONSTRAINT `product` FOREIGN KEY (`product_id`) REFERENCES `DBNAMEproduct`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
