...
ALTER TABLE `DBNAMEorder` DROP FOREIGN KEY `address_id`;
ALTER TABLE `DBNAMEorder` ADD CONSTRAINT `user_address` FOREIGN KEY (`address_id`) REFERENCES `DBNAMEaddress` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION;
...
ALTER TABLE `DBNAMEmenu_product` DROP FOREIGN KEY `menu_id`;
ALTER TABLE `DBNAMEmenu_product` ADD CONSTRAINT `menu_id` FOREIGN KEY (`menu_id`) REFERENCES `DBNAMEmenu`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

ALTER TABLE `DBNAMEmenu_product` DROP FOREIGN KEY `product_id`;
ALTER TABLE `DBNAMEmenu_product` ADD CONSTRAINT `product_id` FOREIGN KEY (`product_id`) REFERENCES `DBNAMEproduct`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
